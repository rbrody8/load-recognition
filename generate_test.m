% DESCRIPTION
% This function creates a test for the classify() funciton using phase current
% waveforms from textToArr.m and zero-crossings returned from
% get_crossings.m
...
function [test] = generate_test(data_dir)
    ...
    test = test'; % transposing the training matrix to work for "classify"
